...
# ╔═╡ ab3acd04-5500-11f1-bbd3-e1c7107c3afc
begin
...
# ╔═╡ 3868859c-c7a5-4d02-bdd3-24dc7d4ebdb5
using RationalFunctionApproximation

# ╔═╡ b8234c93-8adf-4549-9b3f-245b31225b79
md"""
...
# ╔═╡ d5d70f94-c6a3-4a95-82cf-68b3893eeee0
begin
		n1 = 20
...
# ╔═╡ 0f01c1a2-b2a7-4cc6-ac0b-073e8789fec5
...
# ╔═╡ 5efd0972-196a-4be4-a40e-4670065b2ac7
u0 = eigenfuncs_initial_vec(n1)[:]

# ╔═╡ 310246c4-c01b-4b99-b2cc-f6c612b632f2
begin
	t = 0.2
	tLh = t*Lh
...
# ╔═╡ 0e40c9af-3433-434d-a8e1-b609b6d4c1c3
fk = krylov_approx(exp,tLh,u0,40)

# ╔═╡ 6639cea6-c860-4669-99a7-097e99c9479e
rel_err(ex,ap) = norm(ap - ex)/norm(ex)

# ╔═╡ 8b5c3e30-f83b-4a85-aae7-a1edac4473a6
rel_err(exact,fk)
...
AppleAccelerate = "~0.6.0"
CairoMakie = "~0.15.9"
DataFrames = "~1.8.2"
KrylovKit = "~0.10.3"
RationalFunctionApproximation = "~0.3.5"
Tullio = "~0.3.8"
"""
...
manifest_format = "2.0"
project_hash = "6e705e10d88886a9eec438ed0ffe26fb4485da5f"
...
git-tree-sha1 = "1e2ae4d0ebdfdbc297864db404df47b71d49d025"
...
git-tree-sha1 = "d3fe615e394f765b7ef7e0a1ca10b007305d7e6f"
...
[[deps.ArnoldiVandermonde]]
deps = ["LinearAlgebra"]
git-tree-sha1 = "363ce8ba0b248b2f4ff2b5dcfac58f6269a2e73f"
uuid = "dfb2314e-7b44-493c-847d-ffb1b242c444"
version = "0.1.0"
...
git-tree-sha1 = "493581e93b04430d73314f9a55a934aae26f5533"
uuid = "c64915e2-6c82-11e9-38e9-1f159a780463"
version = "0.3.9"

    [deps.ComplexRegions.extensions]
    ComplexRegionsMakieExt = "Makie"
    ComplexRegionsPlotsExt = "Plots"
    ComplexRegionsPythonCallExt = "PythonCall"

    [deps.ComplexRegions.weakdeps]
...
[[deps.RationalFunctionApproximation]]
deps = ["ArnoldiVandermonde", "ComplexRegions", "ComplexValues", "GenericLinearAlgebra", "GenericSchur", "LinearAlgebra", "Logging", "PrecompileTools", "Printf", "PyFormattedStrings", "Statistics"]
git-tree-sha1 = "8c59d2f0edf276a13dd53daf92e17b3662366119"
uuid = "c92886a3-cb30-4e18-b84f-372dde475ecc"
version = "0.3.5"

    [deps.RationalFunctionApproximation.extensions]
    ...
    [deps.RationalFunctionApproximation.weakdeps]
    ForwardDiff = "f6369f11-7733-5829-9624-2563aa707210"
    Makie = "ee78f7c6-11fb-53f2-987a-cfe4a2b5a57a"
    Plots = "91a5bcdd-55d7-5caf-9e0b-520d859cae80"
    PythonCall = "6099a3de-0909-46bc-b1f4-468b9a2dfc0d"
